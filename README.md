...
- Exploring the role of problem structure in QAOA performance [`examples/QAOA symmetry and performance.ipynb`](https://github.com/QAOAKit/QAOAKit/blob/master/examples/QAOA%20symmetry%20and%20performance.ipynb)
